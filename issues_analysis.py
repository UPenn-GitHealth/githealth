...
def generate_issues_first_resp_table(files):
    ...
    subset_issues_data.to_csv('issues_table.csv', index=False)  # Save to a CSV file
...
print("Issues table saved to issues_table.csv")
...
plot_avg_first_resp_time('issues_table.csv')
